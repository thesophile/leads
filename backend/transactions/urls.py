...
urlpatterns = [
    ...
    path('leads/bulk-delete/', LeadBulkDeleteView.as_view(), name='transactions-leads-bulk-delete'),
    path('leads/import/', LeadImportView.as_view(), name='transactions-leads-import'),
    ...
    path('leads/reassign/', LeadReassignView.as_view(), name='transactions-leads-reassign'),
