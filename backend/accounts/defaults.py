# Default Terms & Conditions text seeded onto every new company. Company
# admins can edit these from Settings -> Templates; the text is injected into
# generated proposals and order forms.
