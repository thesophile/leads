...
import { t as require_react_is } from "./react-is-CwUNmt5A.js";
...
//#endregion
//#region node_modules/react-barcode/lib/react-barcode.js
var require_react_barcode = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	if (version[0] === "0" && (version[1] === "13" || version[1] === "12")) getDOMNode = function getDOMNode(ref) {
		return ref.getDOMNode();
	};
	else getDOMNode = function getDOMNode(ref) {
		return ref;
	};
		...
		_createClass(Barcode, [
			...
			},
			{
				...
				value: function update() {
					...
					try {
						new _jsbarcode["default"](renderElement, this.props.value, Object.assign({ text: this.props.text || this.props.value }, this.props));
					} catch (e) {
			...
			},
			{
				...
				value: function render() {
					...
					if (this.props.renderer === "svg") return _react["default"].createElement("svg", {
						ref: this.renderElementRef,
						id,
						className
					});
					else if (this.props.renderer === "canvas") return _react["default"].createElement("canvas", {
						ref: this.renderElementRef,
						id,
						className
					});
					else if (this.props.renderer === "img") return _react["default"].createElement("img", {
						ref: this.renderElementRef,
						id,
						className
					});
